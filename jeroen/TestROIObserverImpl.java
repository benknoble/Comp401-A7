...
public class TestROIObserverImpl implements TestROIObserver {
	...
	@Override
	/*
	 * Outputs some text and sets the _lastPicture and _lastRegion fields to
	 * parameters for jUnit testing.
	 */
	public void notify(ObservablePicture picture, Region changed_region) {
		System.out.println("Hey you guys, " + this + " here! I just got a call from " + picture + ".");
		System.out.println("Something happened in the region with coordinates " + changed_region.getLeft() + ","
				+ changed_region.getTop() + " and " + changed_region.getRight() + "," + changed_region.getBottom());
